...
class PharosTestnet:
    def __init__(self) -> None:
        ...
        self.WPHRS_CONTRACT_ADDRESS = "0xd6AD40a0d3d27006d46D6f2B0d8fECB7805e4884"
        self.USDC_CONTRACT_ADDRESS = "0xd6AD40a0d3d27006d46D6f2B0d8fECB7805e4884"
        self.USDT_CONTRACT_ADDRESS = "0xd6AD40a0d3d27006d46D6f2B0d8fECB7805e4884"
        self.SWAP_ROUTER_ADDRESS = "0xd6AD40a0d3d27006d46D6f2B0d8fECB7805e4884"
        self.POTITION_MANAGER_ADDRESS = "0xd6AD40a0d3d27006d46D6f2B0d8fECB7805e4884"
    ...
    def welcome(self):
        print(
            f"""
        {Fore.GREEN + Style.BRIGHT} Pharos-Pro {Fore.BLUE + Style.BRIGHT} Auto BOT
            """
            f"""
        {Fore.GREEN + Style.BRIGHT} 𝚃𝚎𝚕𝚎𝚐𝚛𝚊𝚖 𝚌𝚑𝚊𝚗𝚗𝚎𝚕 𝚕𝚒𝚗𝚔  {Fore.YELLOW + Style.BRIGHT} > https://t.me/BilalStudio3
            """
        )
...
if __name__ == "__main__":
    try:
        ...
        print(
            f"{Fore.CYAN + Style.BRIGHT}[ {datetime.now().astimezone(wib).strftime('%x %X %Z')} ]{Style.RESET_ALL}"
            f"{Fore.WHITE + Style.BRIGHT} | {Style.RESET_ALL}"
            f"{Fore.RED + Style.BRIGHT}[ EXIT ] Pharos-Pro - BOT{Style.RESET_ALL}                                       "                              
        )